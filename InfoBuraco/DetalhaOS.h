...
namespace InfoBuraco {
	...
	/// <summary>
	/// Summary for DetalhaOS
	/// </summary>
	public ref class DetalhaOS : public System::Windows::Forms::Form
	{
	public:
		DetalhaOS(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->statusCb->SelectedIndexChanged += gcnew System::EventHandler(this, &DetalhaOS::statusCb_SelectedIndexChanged);
			// 
			// cancelBtn
			// 
			...
			this->cancelBtn->Click += gcnew System::EventHandler(this, &DetalhaOS::cancelBtn_Click);
			// 
			// comboBox2
			// 
			...
			this->saveBtn->Click += gcnew System::EventHandler(this, &DetalhaOS::saveBtn_Click);
			// 
			// textBox1
			// 
			...
			this->Name = L"DetalhaOS";
			this->Text = L"Editar Ordem de Serviço";
